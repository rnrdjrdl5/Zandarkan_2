Shader "Zan_Shader/Emoticon/Angry_Emoticon" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			if ( a == 1 )
			{
				g = tex2D(_MainTex4,IN.uv_MainTex4*(0.7*a)+(0.15*a));
			}
			else
			{
				g = tex2D(_MainTex4,IN.uv_MainTex4);
			}
				
			o.Albedo = c*lerp(0,d,c.a);
			o.Albedo = c*lerp(o.Albedo,f,f.a);
			o.Albedo = lerp(o.Albedo,g,g.a)*_Color;
			//o.Emission = float3(IN.uv_MainTex4.x,IN.uv_MainTex4.y,0);
			o.Alpha = c.a+g.a;
		}
